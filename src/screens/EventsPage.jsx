        ...
        <div className=''>
            ...
            <div className='flex-grow p-4 ml-72'>
                <div className='flex justify-end mb-10 '>
                    ...
                    {user && user.rol === "ADMIN" && (
                        <button onClick={handleCreateEventClick} className='w-36 h-10 border bg-gray-700 text-white font-semibold hover:bg-gray-900 rounded-lg flex justify-center items-center'>Crear Evento</button>
                    )}
                </div>
